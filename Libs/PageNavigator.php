...
class PageNavigator{
	...
	private $spannextinactive = 'nextButton';
	private $spanpreviousinactive = 'prevButton';

	//first and last inactive
	private $firstinactivespan = 'fristButton';
	private $lastinactivespan = 'lastButton';  
	...
	private $errorstring;  
        ...
        public static function factory( $pagename, $totalrecords, $recordsperpage, $recordoffset, $maxpagesshown = 4, $params = "" ){
            return new PageNavigator($pagename, $totalrecords, $recordsperpage, $recordoffset, $maxpagesshown, $params);
        }
...
*/
	public function getNavigator(){
		...
		if( $this->currentpage == 0 )
		  ...
		  $strnavigator .= $this->createLink( 0, $this->strfirst, $this->firstinactivespan );
		
		// ������ ���������� ������
		if( $this->currentpage == 0 )
			$strnavigator .= $this->spanpreviousinactive;
		else
			$strnavigator.= $this->createLink( $this->currentpage-1, $this->strprevious, $this->spanpreviousinactive );
		...
		if( $this->currentpage == $this->totalpages - 1 )
		  ...
		  $strnavigator .= $this->createLink( $this->currentpage + 1, $this->strnext, $this->spannextinactive );
		
		//������ last
		if( $this->currentpage == $this->totalpages - 1 )
		  $strnavigator .= $this->lastinactivespan;
		else
		  $strnavigator .= $this->createLink( $this->totalpages - 1, $this->strlast, $this->lastinactivespan );
...
//private methods
////////////////////////////////////////////////////////////////////
	private function createLink( $offset, $strdisplay, $param = null ){
//                if( $param == null)
//                    $param = $this->params;
